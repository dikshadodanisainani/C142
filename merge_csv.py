...
with open(r'C:\Diksha_workplace\python\c-142-main\c-142-main\movies.csv',encoding="utf8") as f:
    reader = csv.reader(f)
    data = list(reader)
    all_movies = data[1:]
    headers = data[0]
...
with open(r"C:\Diksha_workplace\python\c-142-main\c-142-main\movie_links.csv",encoding="utf8") as f:
    reader = csv.reader(f)
    data = list(reader)
